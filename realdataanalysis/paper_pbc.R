...
# ------------------------------------ omni ------------------------------------
result12_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
result12_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
result12_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
...
result12_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
...
result12_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
...
result12_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
...
# ------------------------------------ omni ------------------------------------
result16_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
...
# ------------------------------------ link ------------------------------------
result16_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mis")
...
# ------------------------------------ form ------------------------------------
result16_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
...
result16_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
...
result16_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
...
result16_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
beta12=aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,eqType="mis")
summary(beta12)

beta16=aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,eqType="mis")
summary(beta16)

{
  ...
  # ------------------------------------ omni ------------------------------------
  result01_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result01_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result01_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result01_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result01_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result01_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result02_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result02_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result02_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result02_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result02_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result02_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result03_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result03_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result03_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result03_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result03_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result03_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result04_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result04_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result04_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result04_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result04_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result04_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result05_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result05_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result05_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result05_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result05_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result05_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result06_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result06_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result06_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result06_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result06_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result06_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result07_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result07_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result07_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result07_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result07_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result07_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result08_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result08_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result08_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result08_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result08_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result08_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result09_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result09_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result09_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result09_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result09_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result09_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result10_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result10_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result10_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result10_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result10_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result10_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result11_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result11_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result11_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result11_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result11_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result11_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result12_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result12_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result12_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result12_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result12_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result12_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mns",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result13_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result13_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result13_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result13_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result13_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="albumin")
  ...
  result13_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result14_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result14_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result14_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result14_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="protime")
  ...
  result14_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result14_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result15_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result15_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result15_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="bili")
  ...
  result15_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result15_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result15_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result16_afttest_omni_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mns")
  ...
  # ------------------------------------ link ------------------------------------
  result16_afttest_link_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mns")
  ...
  # ------------------------------------ form ------------------------------------
  result16_afttest_form1_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_bili")
  ...
  result16_afttest_form2_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_protime")
  ...
  result16_afttest_form3_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_albumin")
  ...
  result16_afttest_form4_mns=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mns",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result01_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result01_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result01_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result01_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result01_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result01_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result02_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result02_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result02_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result02_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result02_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result02_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result03_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result03_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result03_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result03_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result03_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result03_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result04_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result04_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result04_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result04_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result04_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result04_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result05_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result05_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result05_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result05_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result05_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result05_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result06_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result06_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result06_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result06_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result06_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result06_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result07_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result07_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result07_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result07_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result07_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result07_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result08_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result08_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result08_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result08_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result08_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result08_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result09_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result09_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result09_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result09_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result09_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result09_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+age+edema,path=path,testtype="form",eqType="mis",form="age")
  ...
  # ------------------------------------ omni ------------------------------------
  result10_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result10_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result10_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result10_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result10_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result10_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result11_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result11_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result11_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result11_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result11_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result11_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result13_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result13_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result13_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result13_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result13_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="albumin")
  ...
  result13_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result14_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result14_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result14_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_bili")
  ...
  result14_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="protime")
  ...
  result14_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result14_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~log_bili+protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------ omni ------------------------------------
  result15_afttest_omni_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="omni",eqType="mis")
  ...
  # ------------------------------------ link ------------------------------------
  result15_afttest_link_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="link",eqType="mis")
  ...
  # ------------------------------------ form ------------------------------------
  result15_afttest_form1_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="bili")
  ...
  result15_afttest_form2_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_protime")
  ...
  result15_afttest_form3_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_albumin")
  ...
  result15_afttest_form4_mis=afttest(Surv(X_pbc,D_pbc)~bili+log_protime+log_albumin+log_age+edema,path=path,testtype="form",eqType="mis",form="log_age")
  ...
  # ------------------------------------------------------------------------------
  # ------------------------------------------------------------------------------
  beta11=aftsrr(Surv(X_pbc,D_pbc)~log_bili+protime+albumin+log_age+edema,eqType="mis")
  summary(beta11)
  
  beta16=aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_protime+albumin+log_age+edema,eqType="mis")
  summary(beta16)
  
  beta19=aftsrr(Surv(X_pbc,D_pbc)~log_bili+log_protime+log_albumin+log_age+edema,eqType="mis")
  summary(beta19)
}
