...
# ------------------------------------------------------------------------------
gamma0_result = read.table("afttest0_result.txt", header = TRUE, sep = "", dec = ".", fill = T)

gamma0_sim = nrow(gamma0_result)-sum(apply(gamma0_result, 1, function(l) (sum(is.na(l))>0)))
...
# ------------------------------------------------------------------------------
gamma1_result = read.table("afttest1_result.txt", header = TRUE, sep = "", dec = ".", fill = T)

gamma1_sim = nrow(gamma1_result)-sum(apply(gamma1_result, 1, function(l) (sum(is.na(l))>0)))
...
# ------------------------------------------------------------------------------
gamma2_result = read.table("afttest2_result.txt", header = TRUE, sep = "", dec = ".", fill = T)

gamma2_sim = nrow(gamma2_result)-sum(apply(gamma2_result, 1, function(l) (sum(is.na(l))>0)))
...
# ------------------------------------------------------------------------------
gamma3_result = read.table("afttest3_result.txt", header = TRUE, sep = "", dec = ".", fill = T)

gamma3_sim = nrow(gamma3_result)-sum(apply(gamma3_result, 1, function(l) (sum(is.na(l))>0)))
...
# ------------------------------------------------------------------------------
gamma4_result = read.table("afttest4_result.txt", header = TRUE, sep = "", dec = ".", fill = T)
...
# ------------------------------------------------------------------------------
gamma5_result = read.table("afttest5_result.txt", header = TRUE, sep = "", dec = ".", fill = T)

gamma5_sim = nrow(gamma5_result)-sum(apply(gamma5_result, 1, function(l) (sum(is.na(l))>0)))
